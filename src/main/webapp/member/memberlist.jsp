...
<%-- 							<a href="${cp }/pagingUser?page=1&pageSize=${pageVo.pageSize}">,,,</a> --%>
						...
						<ul class="pagination justify-content-center m-0">
							<li class="page-item"><a class="page-link" href="${cp }/pagingMember.do?page=1&pageSize=${pageVo.pageSize }">
								...
								<c:choose>
									<c:when test="${pageVo.page == i && i > 0}">
							<li class="page-item"><a class="page-link" href="${cp }/pagingMember.do?page=${i-1 }&pageSize=${pageVo.pageSize }"><i class="fas fa-angle-left"></i></a></li>
									</c:when>
									<c:otherwise>
									<li class="page-item"><a class="page-link" href="${cp }/pagingMember.do?page=${1 }&pageSize=${pageVo.pageSize }"><i class="fas fa-angle-left"></i></a></li>
									</c:otherwise>
								</c:choose>
								</c:forEach>
								<c:forEach begin="1" end="${pagination }" var="i">
								...
								<c:otherwise>
										<li class="page-item active"><a class="page-link" href="${cp }/pagingMember.do?page=${i }&pageSize=${pageVo.pageSize}">
										${i }</a></li>
								</c:otherwise>
									</c:choose>
								</c:forEach>
									<li class="page-item"><a class="page-link" href="${cp }/pagingMember.do?page=${i+1 }&pageSize=${pageVo.pageSize }"><i class="fas fa-angle-right"></i></a></li>
